  ...
  return (
    <div className="min-h-screen space-y-6">
              ...
              {phases.map((phase, phaseIndex) => (
                <div key={`thinking-${phase.id}`} className="w-64 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="ghost"
                      className="w-full border text-white border-dashed border-gray-600 hover:border-blue-500"
                      onClick={() => {
                        setSelectedPhase(phaseIndex);
      ...
      <Dialog open={showAddCard} onOpenChange={setShowAddCard}>
        <DialogContent className="sm:max-w-md bg-[#0f0f43]">
          <DialogHeader>
            <DialogTitle className="text-white">Add Journey Card</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 pt-4">
            <div>
              <h4 className="text-sm font-medium text-gray-400 mb-2">Card Content</h4>
              <Textarea
