...
import { Brain, ArrowRight, Loader2, MessageSquare, Lightbulb, ArrowLeft } from "lucide-react";
import Link from 'next/link';
import { useLazyGetPersonaByIdQuery } from '@/services/personaService';
...
export default function InterviewPage() {
  ...
  const [GetPersonaById,getPersonaProps] = useLazyGetPersonaByIdQuery()

  useEffect(() => {
    GetPersonaById({id,authToken:authDeatils.token})
  }, [])
    ...
    <div className="min-h-screen space-y-6 p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-[#0f0f43] p-1">
          ...
          <TabsTrigger value="next-steps" className="data-[state=active]:bg-blue-600">
                ...
                {loading ? (
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-500/10 p-4 rounded-lg">
                      <p className="text-gray-300">{getPersonaProps?.data?.data?.analysis}</p>
                    </div>
